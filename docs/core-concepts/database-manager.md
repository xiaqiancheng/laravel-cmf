...
LaravelCmf has some awesome database tools which allow you to Add/Edit/Delete or view current database tables. The other cool part of LaravelCmf is that you can add BREAD or \(Browse, Read, Edit, Add, & Delete\) functionality to any of your tables.
