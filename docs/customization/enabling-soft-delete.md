...
This is only to assist with enabling soft-deletion for your models within LaravelCmf. Please refer to the [Laravel documentation](https://laravel.com/docs/eloquent#soft-deleting) for specifics.

## Table Configurations in LaravelCmf
