...
trait LaravelCmfUser
{
    ...
    {
        return $this->belongsTo(LaravelCmf::modelClass('Role'));
    }
    ...
    {
        return $this->belongsToMany(LaravelCmf::modelClass('Role'), 'user_roles');
    }
    ...
    {
        $role = LaravelCmf::model('Role')->where('name', '=', $name)->first();
