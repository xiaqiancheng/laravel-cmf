...
class AdminCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'laravel-cmf:admin';
    ...
    public function handle()
    {
        ...
        // Get all permissions
        $permissions = LaravelCmf::model('Permission')->all();
    ...
    {
        $role = LaravelCmf::model('Role')->firstOrNew([
            'name' => 'admin',
        ]);
    ...
    protected function getUser($create = false)
    {
        ...
        $model = config('laravel-cmf.user.namespace') ?: config('auth.providers.users.model');
