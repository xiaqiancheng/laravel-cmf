...
class MenuItem extends Model
{
    ...
    {
        return $this->hasMany(LaravelCmf::modelClass('MenuItem'), 'parent_id')
            ->with('children');
    }

    public function menu()
    {
        return $this->belongsTo(LaravelCmf::modelClass('Menu'));
    }
    ...
    {
        //Remove from cache
        \Cache::forget('laravel_cmf_menu_'.$this->menu->name);
