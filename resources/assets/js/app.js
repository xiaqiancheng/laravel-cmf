...
require('./laravel_cmf_tinymce');
require('./laravel_cmf_ace_editor');
...
$(document).ready(function () {
    ...
    $('#laravel-cmf-loader').fadeOut();

    $(".hamburger, .navbar-expand-toggle").on('click', function () {
        appContainer.toggleClass("expanded");
        $(this).toggleClass('is-active');
        if ($(this).hasClass('is-active')) {
            window.localStorage.setItem('laravel-cmf.stickySidebar', true);
        } else {
            window.localStorage.setItem('laravel-cmf.stickySidebar', false);
        }
    });
    ...
    $(document).on('click', '.panel-heading a.panel-action[data-toggle="panel-collapse"]', function (e) {
        ...
        if (!$this.hasClass('panel-collapsed')) {
            ...
            $this.removeClass('laravel-cmf-angle-up').addClass('laravel-cmf-angle-down');
        } else {
            $this.parents('.panel').find('.panel-body').slideDown();
            $this.removeClass('panel-collapsed');
            $this.removeClass('laravel-cmf-angle-down').addClass('laravel-cmf-angle-up');
        }
    });
    ...
    $(document).on('click', '.panel-heading a.panel-action[data-toggle="panel-fullscreen"]', function (e) {
        e.preventDefault();
        var $this = $(this);
        if (!$this.hasClass('laravel-cmf-resize-full')) {
            $this.removeClass('laravel-cmf-resize-small').addClass('laravel-cmf-resize-full');
        } else {
            $this.removeClass('laravel-cmf-resize-full').addClass('laravel-cmf-resize-small');
        }
