    ...
    @if(class_exists($options->model))
        ...
        @if($options->type == 'belongsTo')
            ...
            @if(isset($view) && ($view == 'browse' || $view == 'read'))
                ...
                @else
                    <p>{{ __('laravel-cmf::generic.no_results') }}</p>
                @endif
            ...
            @else
                ...
                <select
                    ...
                    data-get-items-route="{{route('laravel-cmf.' . $dataType->slug.'.relation')}}"
            ...
            @else
                <select
                    ...
                    @if(isset($options->taggable) && $options->taggable == 'on')
                        data-route="{{ route('laravel-cmf.'.\Illuminate\Support\Str::slug($options->table).'.store') }}"
                        data-label="{{$options->label}}"
                        data-error-message="{{__('laravel-cmf::bread.error_tagging')}}"
                    @endif
                >
