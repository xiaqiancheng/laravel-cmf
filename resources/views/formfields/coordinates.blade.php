...
@empty
    <input type="hidden" name="{{ $row->field }}[lat]" value="{{ config('laravel-cmf.googlemaps.center.lat') }}" id="lat"/>
    <input type="hidden" name="{{ $row->field }}[lng]" value="{{ config('laravel-cmf.googlemaps.center.lng') }}" id="lng"/>
@endforelse
