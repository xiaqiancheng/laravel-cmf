<style type="text/css">
        .laravel-cmf .compass .nav-tabs{
            background:none;
            border-bottom:0px;
        }

        .laravel-cmf .compass .nav-tabs > li{
            margin-bottom:-1px !important;
        }

        .laravel-cmf .compass .nav-tabs a{
            text-align: center;
            font-size: 10px;
            font-weight: normal;
            background: #f8f8f8;
        ...
        .laravel-cmf .compass .nav-tabs a i{
            display: block;
            font-size: 22px;
        }
        ...
        #gradient_bg{
            ...
            top: 61px;
            left: 0px;
            background-image: url(/vendor/xadmin/laravel-cmf/assets/images/bg.jpg);
        ...
        .laravel-cmf .compass .nav-tabs > li > a:hover{
        ...
        .laravel-cmf-link span.resource_label{
            text-align: center;
            color: #fff;
            display: block;
            position: absolute;
        ...
        .laravel-cmf-link span.resource_label:hover{
            opacity:1;
        }
        ...
        .laravel-cmf-link span.resource_label:hover i{
            
            opacity:1;
            transition:all 0.3s linear;
        }

        .laravel-cmf-link span.copy{
            position: absolute;
            font-size: 16px;
            left: 0px;
            bottom: 70px;
        ...
        .laravel-cmf-angle-down{
            display:none;
        }

        .laravel-cmf-link::after{
            content:'';
            position:absolute;
            width:100%;
            height:100%;
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#b3111111', endColorstr='#b3111117',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */
        ...
        .laravel-cmf #logs .table>thead>tr>th:first-child{
            border-top-left-radius: 3px;
        }

        .laravel-cmf #logs .table>thead>tr>th:last-child{
            border-top-right-radius: 3px;
        }
