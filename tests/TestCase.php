...
class TestCase extends OrchestraTestCase
{
    ...
    {
        return [
            LaravelCmfServiceProvider::class,
        ];
    }
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        // Setup LaravelCmf configuration
        $app['config']->set('laravel-cmf.user.namespace', User::class);
    ...
    {
        $this->artisan('laravel-cmf:install', ['--with-dummy' => $this->withDummy]);

        app(LaravelCmfServiceProvider::class, ['app' => $this->app])->loadAuth();
