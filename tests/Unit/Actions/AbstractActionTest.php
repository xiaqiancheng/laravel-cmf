...
namespace XADMIN\LaravelCmf\Tests\Unit\Actions;
...
class AbstractActionTest extends TestCase
{
     ...
     *
     * @var \XADMIN\LaravelCmf\Models\DataType
     */
     ...
     *
     * @var \XADMIN\LaravelCmf\Models\User
     */
    protected $user;
    ...
    public function setUp(): void
    {
        ...
        $this->userDataType = LaravelCmf::model('DataType')->where('name', 'users')->first();
