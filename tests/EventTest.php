...
class EventTest extends TestCase
{
    ...
    public function testBreadAddedEvent()
    {
        ...
        $this->post(route('laravel-cmf.bread.store'), [
            'name'                  => 'Toast',
            'slug'                  => 'toast',
    ...
    public function testBreadUpdatedEvent()
    {
        ...
        $this->put(route('laravel-cmf.bread.update', [$dataType->id]), [
            'name'                  => 'Test',
            'slug'                  => 'test',
    ...
    public function testBreadDeletedEvent()
    {
        ...
        $this->delete(route('laravel-cmf.bread.delete', [$dataType->id]));
    ...
    public function testBreadDataAddedEvent()
    {
        ...
        $this->post(route('laravel-cmf.pages.store'), [
            'author_id' => 1,
            'title'     => 'Toast',
            'slug'      => 'toasts',
            'status'    => 'ACTIVE',
    ...
    public function testBreadDataUpdatedEvent()
    {
        ...
        $this->put(route('laravel-cmf.pages.update', [$page->id]), [
            'title'  => 'Test',
            'slug'   => 'tests',
            'status' => 'INACTIVE',
        ]);
    ...
    public function testBreadDataDeletedEvent()
    {
        ...
        $this->delete(route('laravel-cmf.pages.destroy', [$page->id]));
    ...
    public function testBreadImagesDeletedEvent()
    {
        ...
        $this->call('POST', route('laravel-cmf.pages.store'), [
            'author_id' => 1,
            'title'     => 'Toast',
            'slug'      => 'toasts',
            'status'    => 'ACTIVE',
    ...
    public function testTableAddedEvent()
    {
        ...
        $this->post(route('laravel-cmf.database.store'), [
            'table' => [
                'name'    => 'test',
                'columns' => [
                    [
    ...
    public function testTableUpdatedEvent()
    {
        ...
        $this->put(route('laravel-cmf.database.update', ['test']), [
            'table' => json_encode([
                'name'    => 'test',
                'oldName' => 'test',
                'columns' => [
    ...
    public function testTableDeletedEvent()
    {
        ...
        $this->delete(route('laravel-cmf.database.destroy', ['test']));
    ...
    public function testMediaFileAddedEvent()
    {
        ...
        $this->json('POST', route('laravel-cmf.media.upload'), ['file'=>$image]);
