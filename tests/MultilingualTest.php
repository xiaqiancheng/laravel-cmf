...
use XADMIN\LaravelCmf\Translator\Collection;
...
class MultilingualTest extends TestCase
{
    public function setUp(): void
    {
        ...
        config()->set('laravel-cmf.multilingual.locales', ['en', 'da']);

        // Turn on multilingual
        config()->set('laravel-cmf.multilingual.enabled', true);
    }

    public function testCheckingModelIsTranslatable()
    {
        $this->assertTrue(LaravelCmf::translatable(TranslatableModel::class));
        $this->assertTrue(LaravelCmf::translatable(ActuallyTranslatableModel::class));
    }

    public function testCheckingModelIsNotTranslatable()
    {
        $this->assertFalse(LaravelCmf::translatable(NotTranslatableModel::class));
        $this->assertFalse(LaravelCmf::translatable(StillNotTranslatableModel::class));
    }
