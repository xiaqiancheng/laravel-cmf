...
class PagesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if (!$dataType->exists) {
            $dataType->fill([
                'name'                  => 'pages',
                'display_name_singular' => __('laravel-cmf::seeders.data_types.page.singular'),
                'display_name_plural'   => __('laravel-cmf::seeders.data_types.page.plural'),
                'icon'                  => 'laravel-cmf-file-text',
                'model_name'            => 'XADMIN\\LaravelCmf\\Models\\Page',
                'controller'            => '',
        ...
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'image',
                'display_name' => __('laravel-cmf::seeders.data_rows.page_image'),
                'required'     => 0,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $menuItem = MenuItem::firstOrNew([
            'menu_id' => $menu->id,
            'title'   => __('laravel-cmf::seeders.menu_items.pages'),
            'url'     => '',
        ...
        if (!$menuItem->exists) {
            $menuItem->fill([
                'target'     => '_self',
                'icon_class' => 'laravel-cmf-file-text',
                'color'      => null,
                'parent_id'  => null,
                'order'      => 7,
            ])->save();
