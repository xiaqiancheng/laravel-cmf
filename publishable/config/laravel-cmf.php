...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify laravel-cmf user configs
    |
    */
    ...
    'user' => [
        ...
        // However make sure the appointed class must ready to use before installing laravel-cmf.
        // Otherwise `php artisan laravel-cmf:install` will fail with class not found error.
        'namespace'                    => null,
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify laravel-cmf database settings
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify if you want LaravelCmf to ship with support for
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When a change happens on LaravelCmf, we can automate some routines.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you change some of the LaravelCmf UI settings.
    |
    */
