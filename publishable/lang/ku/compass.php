...
return [
    'welcome'                => 'بەخێربێیت بۆ قیبلەنمای ڤۆیەیجەر (LaravelCmf). هەموو ئەپڵیکەیشنێک پێویستی بە قیبلەنمایەکە بۆ نیشاندانی ڕێی ڕاست.
    ...
    'links'         => [
        ...
        'laravel_cmf_homepage'      => 'پەڕەی سەرەتای ڤۆیەیجەر (LaravelCmf)',
        'laravel_cmf_hooks'         => 'هووکەکانی ڤۆیەیجەر (LaravelCmf)',
    ],
    'commands'      => [
        'title'                 => 'ناونیشان',
